...
val MaterialSymbolsBarcodeReader: ImageVector
  get() {
    if (_MaterialSymbolsBarcodeReader != null) return _MaterialSymbolsBarcodeReader!!

    _MaterialSymbolsBarcodeReader =
        ImageVector.Builder(
                name = "barcode_reader",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
    ...
    return _MaterialSymbolsBarcodeReader!!
  }

private var _MaterialSymbolsBarcodeReader: ImageVector? = null
