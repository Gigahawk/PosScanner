...
val MaterialSymbolsQuestionMark: ImageVector
  get() {
    if (_MaterialSymbolsQuestionMark != null) return _MaterialSymbolsQuestionMark!!

    _MaterialSymbolsQuestionMark =
        ImageVector.Builder(
                name = "question_mark",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
    ...
    return _MaterialSymbolsQuestionMark!!
  }

private var _MaterialSymbolsQuestionMark: ImageVector? = null
