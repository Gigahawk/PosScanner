...
val MaterialSymbolsWatch: ImageVector
  get() {
    if (_MaterialSymbolsWatch != null) return _MaterialSymbolsWatch!!

    _MaterialSymbolsWatch =
        ImageVector.Builder(
                name = "watch",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
    ...
    return _MaterialSymbolsWatch!!
  }

private var _MaterialSymbolsWatch: ImageVector? = null
